...
#### New functions: 
lm(), geom_smooth(), geom_ribbon(), plot.lm(), coef(), anova(), broom::tidy(), predict(), ggPredict(), expand.grid()         (AIC(), step(), ...?)
...
#### Two continuous variables (do this as an exercise?)

What if you were working with taxadermy penguins from a museum collection and could measure bill depth and bill length but needed to use those to predict body mass?
