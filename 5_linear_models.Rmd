...
While `ggPredict()` is a fabulous function, there is not a lot of room to customize it. The more formal and more customizable method for accessing your model predictions is using the `predict()` function. 
