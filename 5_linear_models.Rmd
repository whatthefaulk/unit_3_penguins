...
-  Root of Standardized residuals vs Fitted values, this is very similar to number 1, where the Y axis of residuals is in a different metric (notice cases 4, 18, and 38 are labelled again, just like our first figure).
...
Another quick-and-dirty set of diagnostics is `glvlma()` in the `gvlma` package. 
